                ...
                <div className="row">
                    <div className="col-md-12 col-sm-12 resume-item d-flex flex-column flex-md-row justify-content-between mb-4">
                        ...
                        <span className="text-primary">February 2018 - December 2019</span>
                            <h3 className="mb-0">Technical and Administrative Support Assistant</h3><h4>Office of Accreditation, College Of Business</h4>
                            ...
                            <p className="mb-3 lead">
                                ...
                                California State Universities for the Business Assessment Test to assess their business school for accreditation.
                                <br></br>
                                ★ Reviewed resumes of faculty to classify them according to a given standard,
                                 and entered into the accreditation database.
                                <br></br>
                                ★ Trained incoming employees on the database and all other required responsibilities.
                                <br></br>
                                ★ Interacted with people from a different professional background and acted as an interpreter in meetings with the webmaster of the department.
                            </p>
                    ...
                    <div className="col-md-12 col-sm-12 resume-item d-flex flex-column flex-md-row justify-content-between mb-4">
                        ...
                        <span className="text-primary">June 2015 - October 2015</span>
                            <h3 className="mb-0">Frontend Web Developer Intern</h3><h4>Pavoh</h4>
